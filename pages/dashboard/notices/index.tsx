...
IMPORTANT: This is a template — not legal advice. Keep a record of service (recorded delivery or witnessed hand delivery).`
  ...
  return (
    <Layout>
      <ProGate feature="Legal notice generator" description="Generate Section 8 and Section 13 notices in minutes, pre-filled with your tenant data. RRA 2025 compliant." isPro={isPro} planLoading={planLoading}>
