...
const PROVIDERS = [
  { name: 'OpenRent Referencing', description: 'Full reference including credit check, employment and previous landlord.', price: 'From £20/tenant', speed: '24-48 hours', href: 'https://www.openrent.co.uk/tenant-referencing', rating: '★★★★★', highlight: 'Most popular' },
  { name: 'Vouch', description: 'Digital referencing platform. Tenants complete online. Includes Right to Rent check.', price: 'From £18/tenant', speed: '24 hours', href: 'https://www.vouch.co.uk', rating: '★★★★★', highlight: 'Fastest turnaround' },
  { name: 'Let Alliance', description: 'Comprehensive referencing with rent guarantee insurance option.', price: 'From £27/tenant', speed: '2-3 days', href: 'https://www.letalliance.co.uk', rating: '★★★★☆', highlight: 'Best with rent guarantee' },
  { name: 'HomeLet', description: "One of the UK's largest referencing providers. Includes income verification.", price: 'From £22/tenant', speed: '2-3 days', href: 'https://www.homelet.co.uk/landlord-insurance/tenant-referencing', rating: '★★★★☆', highlight: 'Most established' },
]
    ...
    <Layout>
      <div className="p-8 max-w-3xl">
        ...
        <div className="flex items-start gap-2 p-3 rounded-xl mb-8 text-sm" style={{ background: 'var(--color-background-secondary)', color: 'var(--text-secondary)' }}>
          ...
          <span>Always reference tenants before signing. Under the Renters Rights Act 2025, thorough referencing protects you if you later need to recover possession.</span>
        </div>
          ...
          {PROVIDERS.map(p => (
            <div key={p.name} className="card p-5">
              <div className="flex items-start justify-between gap-4">
                ...
                <a href={p.href} target="_blank" rel="noopener noreferrer" className="btn-primary flex items-center gap-1.5 text-sm flex-shrink-0 whitespace-nowrap">
