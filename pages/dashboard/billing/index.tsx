...
const PRO_FEATURES = ['Unlimited properties','Everything in Free','RRA 2025 compliance checklist','Tenancy agreement (AST) generator','Section 8 & 13 legal notice generator','Maintenance issue tracking','Document storage & expiry alerts','Deposit tracking (DPS / TDS / MyDeposits)','Automated tenant email reminders','GoCardless Direct Debit (coming soon)']
