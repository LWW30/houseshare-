...
export default function BillingPage() {
  ...
  const perMonth = plan === 'monthly' ? MONTHLY_PRICE : plan === 'annual' ? (ANNUAL_PRICE / 12).toFixed(2) : (FOUNDING_PRICE / 12).toFixed(2)
      ...
      <div className="p-6 md:p-8 max-w-3xl">
          ...
          <div>
            <div className="mb-6 p-5 bg-green-50 border border-green-200 rounded-2xl flex items-center justify-between gap-4">
              ...
              <button onClick={handleManage} disabled={managing}
                ...
                {managing ? <Loader2 size={13} className="animate-spin" /> : null}Manage subscription
              </button>
            </div>
            ...
            <div className="rounded-2xl overflow-hidden mb-6 border-2 border-gray-900">
              <div className="bg-gray-900 text-white px-6 py-5 flex items-center justify-between">
                ...
                <div className="text-right">
                  ...
                  <p className="text-sm text-gray-400">{plan === 'monthly' ? 'per month' : `per year (£${perMonth}/mo)`}</p>
                </div>
              </div>
        ...
        <div className="card p-5">
          ...
          <p className="text-xs" style={{ color: 'var(--text-muted)' }}>
            Questions? <a href="mailto:hello@letflowuk.com" className="underline hover:no-underline" style={{ color: 'var(--text-secondary)' }}>hello@letflowuk.com</a>
          </p>
        </div>
      </div>
    </Layout>
