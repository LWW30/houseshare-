...
export default function Dashboard() {
  ...
  if (loading || dataLoading) return (
    <Layout><div className='flex items-center justify-center h-64'><div className='w-6 h-6 border-2 border-gray-200 border-t-gray-900 rounded-full animate-spin' /></div></Layout>
  )
