    ...
    <div className="px-5 py-4 flex items-center gap-4">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-xs mt-0.5" style={{ color: 'var(--text-secondary)' }}>
          {b.property?.name} · {new Date(b.due_date) < new Date() ? <span style={{color:'#ef4444',fontWeight:600}}>overdue {format(new Date(b.due_date), 'd MMM yyyy')}</span> : <span>due {format(new Date(b.due_date), 'd MMM yyyy')}</span>}
        </div>
      </div>
